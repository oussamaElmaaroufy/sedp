			...
			<div class="columns medium-8 medium-offset-2 small-12">
				...
				<div class="row">
					...
					<div class="columns medium-12 entet">
						<h2>Votre candidature pour le poste de Lorem Ipsum</h2>
						<p>Vous êtes intéressé par une de nos offres d’emploi ?  Renseignez ce formulaire, notre équipe vous répondra dans les plus brefs délais.</p>
					</div>
